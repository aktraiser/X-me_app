...
const ThinkBox = ({ content }: ThinkBoxProps) => {
  ...
  return (
    <div className="bg-light-secondary/50 dark:bg-dark-secondary/50 rounded-xl overflow-hidden">
      ...
      {isExpanded && (
        <div className="px-4 py-3 text-black/80 dark:text-white/80 text-sm border-t border-light-200 dark:border-dark-200 bg-light-100/50 dark:bg-dark-100/50 whitespace-pre-wrap max-h-[400px] overflow-y-auto">
          {content}
        </div>
      )}
    </div>
