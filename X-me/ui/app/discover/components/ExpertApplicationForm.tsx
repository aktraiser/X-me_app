...
export default function ExpertApplicationForm({ onSuccess, onCancel }: ExpertApplicationFormProps) {
  ...
  if (submitted) {
    return (
      <div className="w-full px-4 py-10 pb-16 md:pb-10">
        ...
        <div className="mt-3 text-center">
          <h3 className="text-lg font-semibold leading-6 text-gray-900 dark:text-white">Demande envoyée avec succès</h3>
          <div className="mt-4">
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full px-4 sm:px-0 pb-16 md:pb-0">
      <div className="mt-8 flex items-center gap-x-5">
        ...
        <div>
          <h3 className="text-lg font-semibold leading-6 text-gray-900 dark:text-white">Devenez Expert Xandme</h3>
