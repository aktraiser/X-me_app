                        ...
                        <div className="mt-16 px-6 pb-6">
                          ...
                          <div className="flex flex-wrap gap-3 mt-6">
                            ...
                            <div className="flex items-center gap-2 border rounded-full px-4 py-2 border-gray-200 dark:border-gray-600">
                              ...
                              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{expert.tarif}€ <span className="text-xs font-normal">/jour</span></span>
                            </div>
                      ...
                      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-4">
                            ...
                            {!expert.reseau && !expert.site_web && !expert.logo && (
                              <p className="text-sm text-gray-500 dark:text-gray-400 italic">
